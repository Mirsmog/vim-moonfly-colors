...
M.style = function()
  ...
  highlight(0, "CursorLineNr", { bg = none, fg = emerald })
  ...
  highlight(0, "WinBar", { bg = none, fg = white })
  highlight(0, "WinBarNC", { bg = none, fg = grey62 })
  ...
  highlight(0, "TelescopeSelection", { bg = none, fg = emerald })
  ...
  -- nvim-navic plugin
  highlight(0, "NavicText", { bg = none, fg = grey70 })
  highlight(0, "NavicSeparator", { bg = none, fg = white })
  highlight(0, "NavicIconsOperator", { bg = none, fg = cranberry })
  highlight(0, "NavicIconsBoolean", { link = "NavicIconsOperator" })
  highlight(0, "NavicIconsClass", { bg = none, fg = emerald })
  highlight(0, "NavicIconsConstant", { bg = none, fg = orange })
  highlight(0, "NavicIconsConstructor", { bg = none, fg = sky })
  highlight(0, "NavicIconsEnum", { bg = none, fg = violet })
  highlight(0, "NavicIconsEnumMember", { bg = none, fg = turquoise })
  highlight(0, "NavicIconsEvent", { link = "NavicIconsConstant" })
  highlight(0, "NavicIconsField", { link = "NavicIconsEnumMember" })
  highlight(0, "NavicIconsFile", { bg = none, fg = blue })
  ...
  highlight(0, "NavicIconsNull", { bg = none, fg = green })
  ...
  highlight(0, "NavicIconsString", { bg = none, fg = khaki })
